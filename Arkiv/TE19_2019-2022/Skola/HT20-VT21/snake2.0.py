...
height = 1, width = 30, font=("Impact", 19), bg='white')
score_lbl.grid(column=1, row=0, columnspan=12) 

#Sprites
Bär = Label(window, text=bär_apperance,#🍎
height = 1, width = 2, font=("Arial", 21), bg='#ff0000')
...
setbtn = Button(window, text="Set spike amount", command=lambda: difficulty.set(slider.get()))
