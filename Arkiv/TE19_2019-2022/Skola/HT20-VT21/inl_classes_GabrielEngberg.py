...
Date: 2021
Info:
A file with useful classes and functions.
"""

import os
# Union makes it easier to comment multiple argument types or return types.
...
def lin_search(array:Union[list, dict, tuple, str]
        ...
        if not isinstance(array, str):
            for index, value in enumerate(array):
                ...
                if hasattr(value, "__iter__"):
                    if isinstance(search, str):
                        # To handle arrays with iterables stored in them
                        # Possible to make a recursive call which would solve:
...
if __name__ == "__main__":
    print(lin_search(array=[{"key": "value", "foo": "bar"}, {"daas": "seeex", "baar": "poo"}], search="poo"))
    pass